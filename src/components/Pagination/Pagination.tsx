      ...
      {pages.map((page) => {
        ...
        return (
          <li
            ...
            <Link
              href={`${url}`}
              className={cn('flex h-10 items-center justify-center bg-slate-700 hover:bg-indigo-400/40 px-4 hover:text-slate-300', {'bg-indigo-400/50 text-slate-300 ': isCurrentPage})}>
              {page}
            </Link>
          </li>
        );
